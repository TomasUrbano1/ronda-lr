...
export default function AdminPage() {
  ...
  return (
    <main className="container py-8">
      <h1 className="text-2xl font-bold mb-4" style={{ fontFamily: 'Poppins' }}>
        Admin — Aprobación de vendedores
      </h1>
      ...
      <h2 className="font-semibold mb-3" style={{ fontFamily: 'Poppins' }}>
        Pendientes
      </h2>
      ...
      {loading ? (
        ...
        <div className="text-neutral-600">No hay pendientes.</div>
      ) : (
